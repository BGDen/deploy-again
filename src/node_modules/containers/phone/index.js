...
class Phone extends React.Component{
  ...
  renderSidebar(){ // addPhoneToBasket
    ...
    return(
      ...
      >
        ...
        <Link 
              to='/' 
              style={{textDecoration: 'none', fontSize: '1.4em', fontWeight: 'bolder', color: green['A700'], marginTop: '1em',}}
        >
          Back to store
        </Link>
  ...
  renderContent(){
    ...
    return(
        ...
        >
          <Card style={{width: '23.5em', height: '33em', background: 'white', margin: '1%', marginTop: '2.2%', marginBottom: '2.2%', borderRadius: '9%'}}>
            <CardMedia
                      image={phone.image}
                      title={phone.name}
                      style={{ height: '100%',}}
          ...
          <Grid 
                ...
                justify="center" 
                alignItems='center' 
                style={{width: '24em', height: '33em', marginLeft: '1%', marginRight: '1%',}}
          >
                {this.renderFields()}
            <Typography 
                        variant='h4' 
          ...
          <Grid 
               container
               direction='column'
               style={{width: '13em', height: '33em', marginLeft: '1%', marginRight: '1%',}}
          >
            {this.renderSidebar()}
          </Grid>
  ...
  render(){
    ...
    return(
        <Paper 
              elevation={10} 
              style={{width: '93%', paddingTop: '.2em', paddingBottom: '.2em', margin: '1em', boxSizing: 'border-box', background: brown[800]}}
        >
          <Grid 
               container 
               direction="row" 
